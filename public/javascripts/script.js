...
(function() {
  var $win, icon, iconSize, infowindow, initialize, latlng, mapObj, marker, markers, num, resizeHandler, socket;
  ...
  socket.on('stream', function(data) {
    ...
    if (data.geo) {
      ...
      google.maps.event.addListener(marker, 'mouseover', function(e) {
        ...
        return infowindow.open(mapObj, markers[this.get("id")]);
      });
  ...
  initialize = function() {
    ...
    return mapObj = new google.maps.Map(document.getElementById("map_canvas"), opts);
  };
